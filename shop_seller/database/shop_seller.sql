...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2022 at 10:39 AM
...
(3, 0, 'asin', 'nil', 987654320, 'shop1@gmail.com', '123456', 'asw@gmail.com', 1, 1),
...
(17, 0, 'abhi', 'plkd ', 1234567890, 'abhi@gmail.com', '123', 'abhi@gmail.com', 2, 1);
...
--
ALTER TABLE `register_tb`
  MODIFY `s_register_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
